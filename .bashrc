...
alias github="curl 'https://api.github.com/users/tubbles/repos?per_page=100' 2>/dev/null | grep '\"full_name\": \"' | sed -E 's#.+\": \"Tubbles/(.+)\",#git@github.com:Tubbles/\1.git#g' | sort -f"
